                          ...
                          <figure className="relative z-10">
                            ...
                            <blockquote className=" text-lg leading-relaxed">
                              <p className="text-[#333333] text-base text-[18px]">
                                Mein Lager befindet sich in der Dresdnerstraße
                                und ich bin sehr zufrieden mit der Qualität des
                                Service: Die Räume sind sauber, trocken und
                                warm, es gibt Videoüberwachung, günstige Lage.
                                Die Administratorin half mir bei der Auswahl
                                eines solchen Lagerraum, was mein Problem
                                vollständig löste.
                              </p>
                      ...
                      <div className="overflow-hidden bg-[#E9E8FC80] rounded shadow-2xl text-slate-500 shadow-slate-200">
                        <div className="relative p-6">
                          <figure className="relative z-10">
                            ...
                            <blockquote className=" text-lg leading-relaxed">
                              <p className="text-[#333333] text-base text-[18px]">
                                Ich bin seit Sommer 24 , Benutzer einer
                                Lagerfläche und bin äusserst zufrieden mit dem
                                kompetenten Service des Teams und der
                                Lagerfläche! Ich kann Safestore nur
                                weiterempfehlen !!!
                              </p>
                              <p className="text-[#091725] text-base text-[18px]">
                                Weiterlesen
                      ...
                      <div className="overflow-hidden bg-[#E9E8FC80] rounded shadow-2xl text-slate-500 shadow-slate-200">
                        <div className="relative p-6">
                          <figure className="relative z-10">
                            ...
                            <blockquote className=" text-lg leading-relaxed">
                              <p className="text-[#333333] text-base text-[18px]">
                                Very good customer service, easy access & the
                                storage rooms are available for a reasonable
                                price.
                              </p>
                              <p className="text-[#091725] text-base text-[18px]">
                                Weiterlesen
