      ...
      <>
        <div className="max-w-7xl mx-auto">
          <h3 className="font-bold text-[40px] lg:text-[40px] leading-[36px] text-[#231ADF] text-center pt-10 pb-5">
            Customers rate us with 4.9 stars
          </h3>
                          ...
                          <figure className="relative z-10">
                            ...
                            <blockquote className=" text-lg leading-relaxed">
                              <p className="text-[#333333] text-base text-[18px]">
                                Vestibulum tempus imperdiet sem ac porttitor.
                                Vivamus pulvinar commodo orci, suscipit
                                porttitor velit elementum non. Fusce nec
                                pellentesque erat,
                              </p>
